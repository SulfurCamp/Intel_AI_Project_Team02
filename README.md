...
## 프로젝트 배경과 목표
최근 러-우 전쟁처럼 드론 기반 공습이 일상화되면서, 경량화된 자율 감시 체계의 필요성이 커졌습니다. 우리는 엣지 디바이스에서 빠르고 안정적으로 작동하는 드론 감지·추적 시스템을 구축해, 침입 징후를 조기에 식별하고 대응할 수 있는 프로토타입을 만드는 것을 목표로 삼았습니다.
