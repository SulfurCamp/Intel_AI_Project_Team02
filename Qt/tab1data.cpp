...
void Tab1Data::ensureDb()
{
    ...
    QSqlQuery q(db);
    // ID/날짜/x/y/z/raw
    q.exec("CREATE TABLE IF NOT EXISTS events (id INTEGER PRIMARY KEY AUTOINCREMENT, detection_time TEXT NOT NULL, x REAL NOT NULL, y REAL NOT NULL, z REAL NOT NULL, raw TEXT)");
}
